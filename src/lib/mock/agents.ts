...
export const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    role: "Submits applications for you",
    description: "Drafts tailored applications and submits them — or waits for your green light.",
    status: "active",
    progress: 22,
    tasksToday: 14,
    tasksTotal: 213,
    recentActions: [
      { time: "Just now", text: "Drafting application for Linear" },
      { time: "12 min", text: "Submitted to Vercel" },
      { time: "1 hr", text: "Awaiting review: Notion application" },
    ],
  },
  {
    id: "tracking",
