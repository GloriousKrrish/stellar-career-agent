...
export function useAuthSubmit(redirectTo: "/app/dashboard" | "/app/onboarding" = "/app/dashboard") {
  ...
  const submit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const emailEl = e.currentTarget.querySelector('input[type="email"]') as HTMLInputElement | null;
    const passwordEl = e.currentTarget.querySelector('input[type="password"]') as HTMLInputElement | null;
    const nameEl = e.currentTarget.querySelector('input[placeholder="Alex Morgan"]') as HTMLInputElement | null;
